  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '16px 22px 16px' }}>
        {/* Próxima cita — deep navy bento card */}
        <div style={{
          background: 'var(--ink)', color: 'var(--paper)', borderRadius: 'var(--r-xl)',
          padding: '18px 20px 20px', marginTop: 16,
        ...
        {/* QR / vínculo */}
        <div style={{
          marginTop: 14, background: 'var(--paper-3)',
          border: '1px solid var(--accent-rule)', borderRadius: 'var(--r-xl)', padding: 16,
          display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 16, alignItems: 'center',
        }}>
          <div style={{ width: 96, height: 96, background: 'var(--white)', color: 'var(--ink)', padding: 6, border: '1px solid var(--accent-rule)', borderRadius: 'var(--r-md)' }}>
            <QRBlock size={82} />
          </div>
          <div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{
              ...
              padding: '3px 8px', background: 'var(--alert)', color: 'var(--white)', borderRadius: 999,
            }}>ALERGIA SEVERA</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          <div style={{ background: 'var(--paper-3)', border: '1px solid var(--accent-rule)', borderRadius: 'var(--r-lg)', padding: '12px 14px' }}>
            ...
            <div style={{ display: 'flex', gap: 6, marginTop: 10 }}>
              <span className="chip accent" style={{ padding: '2px 8px' }}>✓ tomado</span>
            </div>
          </div>
          <div style={{ background: 'var(--white)', border: '1px solid var(--rule)', borderRadius: 'var(--r-lg)', padding: '12px 14px' }}>
            ...
            <div style={{ display: 'flex', gap: 6, marginTop: 10 }}>
              <span className="chip" style={{ padding: '2px 8px' }}>+ síntoma</span>
            </div>
          </div>
        </div>
