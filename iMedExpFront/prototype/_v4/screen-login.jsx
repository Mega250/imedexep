      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <div style={{
            ...
            border: '1px solid rgba(255,255,255,0.14)', borderRadius: 'var(--r-lg)',
      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: 460, width: '100%', alignSelf: 'center' }}>
          ...
          <div style={{ marginTop: 36 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', border: '1px solid var(--rule)', borderRadius: 'var(--r-lg)', overflow: 'hidden' }}>
            ...
            <label style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: 'var(--r-md)', fontFamily: 'var(--mono)', fontSize: 14, color: 'var(--ink)',
                }}
              />
            </label>
            <label style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              <input
                ...
                style={{
                  height: 48, padding: '0 14px',
                  border: '1px solid var(--rule)', background: 'var(--white)',
                  borderRadius: 'var(--r-md)', fontFamily: 'var(--mono)', fontSize: 14, letterSpacing: '0.15em',
                }}
              />
            </label>
