    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
        <div style={{
          ...
          border: '1px solid var(--rule)', background: 'var(--white)', borderRadius: 3, width: 320,
        }}>
          ...
          <span style={{ flex: 1 }} />
          <span className="mono" style={{ fontSize: 10.5, color: 'var(--ink-3)', border: '1px solid var(--rule)', padding: '1px 5px', borderRadius: 2 }}>⌘K</span>
        </div>
  ...
  return (
    <div style={{
      ...
      <span style={{
        ...
        padding: '4px 9px 5px', background: 'var(--alert)', color: 'var(--white)', borderRadius: 2,
...
function PatientStrip() {
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 0, border: '1px solid var(--rule)', borderRadius: 3, alignSelf: 'end' }}>
        {[
...
function ChartCard({ title, count, children, accent }) {
  return (
    <div style={{ border: '1px solid var(--rule)', background: 'var(--white)', borderRadius: 4, display: 'flex', flexDirection: 'column' }}>
      <div style={{
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        padding: '12px 16px', borderBottom: '1px solid var(--rule)',
      }}>
        <span className="eyebrow">{title}</span>
        <span className="mono" style={{ fontSize: 11, color: accent ? 'var(--accent-ink)' : 'var(--ink-3)' }}>{count}</span>
      </div>
...
function ChartRow({ a, b, c, severity }) {
  const sev = severity === 'high' ? 'var(--alert)' : severity === 'mid' ? 'oklch(0.65 0.13 75)' : 'var(--accent)';
  return (
    <div style={{
...
function DoctorBody() {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: 14, padding: 28 }}>
      <ChartCard title="Diagnósticos activos" count="4 activos · 1 resuelto">
      ...
      <ChartCard title="Medicación actual" count="3 activos · 1 PRN">
      ...
      <ChartCard title="Cirugías & procedimientos" count="3 procedimientos">
      ...
      <ChartCard title="Estudios recientes" count="últimos 6 meses">
...
function DoctorRightStrip() {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 14, padding: '0 28px 28px' }}>
      {/* Timeline */}
      <div style={{ border: '1px solid var(--rule)', background: 'var(--white)', borderRadius: 4 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 16px', borderBottom: '1px solid var(--rule)' }}>
              ...
              return (
                <div key={i} style={{ position: 'absolute', left: `${e.x}%`, top: top ? 0 : 50, transform: 'translateX(-50%)' }}>
                  ...
                  <div style={{
                    ...
                    background: e.sev === 'high' ? 'var(--alert)' : e.sev === 'mid' ? 'oklch(0.65 0.13 75)' : e.active ? 'var(--accent)' : 'var(--ink)',
                    margin: '0 auto',
                  }} />
                  <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ border: '1px solid var(--rule)', background: 'var(--paper-2)', borderRadius: 4, padding: '14px 16px' }}>
