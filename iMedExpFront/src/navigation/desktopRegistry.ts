...
import { DocAgendarDesktopPage } from "@/atomic/pages/desktop/doctor/DocAgendarDesktopPage";
...
import { PatAsistenteDesktopPage } from "@/atomic/pages/desktop/patient/PatAsistenteDesktopPage";
import { PatRemindersDesktopPage } from "@/atomic/pages/desktop/patient/PatRemindersDesktopPage";
...
export const desktopScreens: Record<string, ComponentType> = {
  ...
  "dsk-doc-agendar": DocAgendarDesktopPage,
  ...
  "pat-asistente": PatAsistenteDesktopPage,
  "pat-recordatorios": PatRemindersDesktopPage,
