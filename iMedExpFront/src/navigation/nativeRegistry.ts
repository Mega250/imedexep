...
import { PatAsistenteMobilePage } from "@/atomic/pages/patient/PatAsistenteMobilePage";
import { PatRemindersMobilePage } from "@/atomic/pages/patient/PatRemindersMobilePage";
...
export const nativeScreens: Record<string, ComponentType> = {
  ...
  "pat-asistente-mob": PatAsistenteMobilePage,
  "pat-recordatorios-mob": PatRemindersMobilePage,
