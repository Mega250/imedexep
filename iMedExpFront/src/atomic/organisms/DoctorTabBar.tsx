...
const TABS: { icon: IconKind; label: string; screen: string }[] = [
  ...
  { icon: "users", label: "Pacientes", screen: "mob-patients" },
  { icon: "cal", label: "Agenda", screen: "mob-agenda" },
  { icon: "clip", label: "Consultas", screen: "mob-consultas" },
  { icon: "rx", label: "Recetas", screen: "mob-recetas" },
  { icon: "shield", label: "Validar", screen: "mob-validaciones" },
  { icon: "user", label: "Perfil", screen: "mob-profile" }
];

type DoctorTabBarProps = {
  active: number;
};

export function DoctorTabBar({ active }: DoctorTabBarProps) {
