...
function SocioeconomicFormCard({
  data,
  onChange,
  onSave,
  saving,
  ...
  return (
    <View style={styles.card}>
      <View style={styles.fieldHead}>
        ...
        {alreadyFilled ? (
          <View style={styles.socFilledBadge}>
            <Icon kind="check" size={11} color={colors.ok} strokeWidth={2.4} />
            <Text style={styles.socFilledText}>Completado</Text>
          </View>
        ) : (
          <Text style={styles.socPendingTag}>sin datos</Text>
        )}
      </View>
      <Text style={styles.socCaption}>
        Esta información se guarda en el perfil del paciente y no se repetirá en futuras consultas.
      </Text>
      <View style={styles.socGrid}>
        <SelectField
              ...
              {phase === "result" ? (
                ...
                <>
                  ...
                  <View style={styles.summary}>
                    ...
                    <SummaryLine label="Datos del hogar" ok={cr.socAlreadyFilled} value={cr.socAlreadyFilled ? "Completado" : "Pendiente"} />
                  </View>
