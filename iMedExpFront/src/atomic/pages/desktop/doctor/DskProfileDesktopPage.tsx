          ...
          <View style={styles.cols}>
            ...
            <View style={styles.colRight}>
              ...
              <FadeIn delay={250}>
                <View style={styles.panel}>
                  <View style={styles.panelHead}>
                    <Text style={styles.panelTitle}>Invitaciones a clínicas</Text>
                  </View>
                  <Tappable
                    onPress={() => goToScreen("doc-invites")}
                    scaleTo={0.99}
                    style={styles.settingRow}
                  >
                    <Icon kind="mail" size={17} color={colors.accentDeep} />
                    <View style={styles.settingInfo}>
                      <Text style={styles.settingTitle}>Bandeja de entrada</Text>
                      <Text style={styles.settingSub}>revisa y responde invitaciones</Text>
                    </View>
                    <Icon kind="chev" size={13} color={colors.ink3} />
                  </Tappable>
                </View>
