...
export function PatientHistoryStep({ form, setForm }: PatientHistoryStepProps) {
  ...
  return (
    <View style={styles.wrap}>
      ...
      <Section title="Antecedentes no patológicos" caption="Estilo de vida y hábitos.">
        <MultiSelectField
      ...
      <Section title="Condiciones del hogar" caption="opcional · puedes completarlo después desde tu perfil.">
        <SelectField
