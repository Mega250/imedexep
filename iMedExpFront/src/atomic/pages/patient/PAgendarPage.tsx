...
export function PAgendarPage() {
  ...
  const [selectedDay, setSelectedDay] = useState<number>(Math.min(todayDay + 5, month.total));
      ...
      <FadeIn delay={200}>
        ...
        <View style={styles.hourGrid}>
          {HOURS.map((h) => {
            ...
            return (
              <Tappable key={h} onPress={() => setSelectedHour(h)} scaleTo={0.95} style={styles.hourTap}>
                <View
                  style={[
                    styles.hourBtn,
                    {
